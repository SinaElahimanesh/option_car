...
class ProductPage extends StatelessWidget {
  final optionFullModel = OptionFullModel(
      name: "ضبط مدل fs logic",
      description: 'Pioneers FS_TSP',
      imageURLs: [
        'assets/images/options/zabt.png',
        'assets/images/options/zabt.png',
        'assets/images/options/zabt.png'
      ],
      hasDiscount: true,
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      CarouselSlider(
                                        ...
                                        items:
                                            optionFullModel.imageURLs.map((i) {
                                          return Builder(
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                          ...
                                          child: Text(optionFullModel.name,
                                              style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 17.0,
                        ...
                        Positioned(
                            child: Row(
                              children: [
                                Visibility(
                                    visible:
                                        optionFullModel.hasInPlaceInstallation,
                                    child: Padding(
                                ...
                                Visibility(
                                    visible:
                                        optionFullModel.hasImmediateDelivery,
                                    child: Padding(
                                        padding: EdgeInsets.symmetric(
                                            vertical: 2, horizontal: 3),
                                        child: SvgPicture.asset(
                        ...
                        child: Column(children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              // Convert each item into a widget based on the type of item it is.
                              itemBuilder: (context, index) {
                                final item = optionFullModel.info.entries
                                    .elementAt(index);
                          ...
                          style: ButtonStyle(
                            backgroundColor:
                              ...
                              (Set<MaterialState> states) {
                                ...
                                return const Color(
                                    0xffdb8c1c); // Use the component's default.
                              },
                            ),
                          ),
                          onPressed: () {},
                          ...
                          style: ButtonStyle(
                            backgroundColor:
                              ...
                              (Set<MaterialState> states) {
                                ...
                                return const Color(
                                    0xfff05e1d); // Use the component's default.
                              },
                            ),
                          ),
                          onPressed: () {},
